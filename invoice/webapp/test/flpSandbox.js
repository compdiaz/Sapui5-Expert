		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ydiazsinvoice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ydiazsinvoice-display": {
								"semanticObject": "ydiazsinvoice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ydiazs.invoice",
									"url": sap.ui.require.toUrl("ydiazs/invoice")
								}
							}
						}
					}
