		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices",
									"targetURL": "#ydiazssapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ydiazssapui5-display": {
								"semanticObject": "ydiazssapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ydiazs.sapui5",
									"url": sap.ui.require.toUrl("ydiazs/sapui5")
								}
							}
						}
					}
